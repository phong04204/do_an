    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ position:"absolute", bottom:0, left:0, right:0, height:"55%", background:"linear-gradient(to top, #0d0820 0%, #1a0a3c 40%, transparent 100%)" }} />
          ...
          <Link href="/" style={{
            ...
            padding:"6px 14px", fontSize:"0.8rem", color:"#fff", textDecoration:"none", fontWeight:500,
          }}>
          ...
          <div style={{ position:"relative", zIndex:1, marginTop:"auto" }}>
            ...
            <div style={{ display:"flex", gap:"6px" }}>
              {[0,1,2].map(i => (
                <div key={i} style={{ height:"4px", borderRadius:"2px", background: i===0 ? "#fff" : "rgba(255,255,255,0.3)", width: i===0 ? "24px" : "12px" }} />
              ))}
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "0.875rem", color: c.sub, marginBottom: "2rem", transition: "color 0.3s" }}>
            Chưa có tài khoản?{" "}
            <Link href="/register" style={{ color: c.linkColor, fontWeight: 600, textDecoration: "none" }}>
              Đăng ký
            </Link>
          </p>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            <input
              ...
              placeholder="Tên đăng nhập" required style={inp}
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginTop:"0.1rem" }}>
              <label style={{ display:"flex", alignItems:"center", gap:"0.6rem", cursor:"pointer" }}>
                <div onClick={() => setRemember(!remember)} style={{
                  ...
                  border: remember ? "none" : `1.5px solid ${c.cbBorder}`,
                  display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", transition:"all 0.15s",
                }}>
                  {remember && <svg width="11" height="8" viewBox="0 0 11 8" fill="none"><path d="M1 4L4 7L10 1" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>}
                </div>
                <span style={{ fontSize:"0.83rem", color: c.remText }}>Ghi nhớ đăng nhập</span>
              </label>
              <Link href="/forgot-password" style={{ fontSize:"0.83rem", color: c.linkColor, fontWeight:600, textDecoration:"none" }}>
                Quên mật khẩu?
              </Link>
            </div>
            ...
            <button type="submit" disabled={isLoading} style={{
              ...
              transition: "opacity 0.2s", marginTop: "0.3rem",
            }}
